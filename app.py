...
# Fiches explicatives des techniques (page de reference pedagogique).
# Chaque champ est bilingue {fr, en}.
TECHNIQUE_DOCS = {
    "override": {
...
# Ressources generales listees en tete de la page Techniques.
TECHNIQUE_RESOURCES = [
...
def register_routes(app):
    ...
    def target_form(target_id=None):
        ...
        return render_template("target_form.html", target=target, targets=targets)
