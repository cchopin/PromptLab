...
CSS = """
:root{--bg:#0c0d10;--bg-alt:#14161b;--panel:#1b1e25;--accent:#9aafce;--text:#f1f3f7;--muted:#b0b6c2;--ok:#a6c0a2;--warn:#cc9a76;--err:#cf8a82;--border:#2a2e37;--mono:"SFMono-Regular","Consolas","Menlo","Monaco",monospace;}
...
.pl-body{background:#090a0d;border:1px solid var(--border);border-radius:4px;padding:10px;white-space:pre-wrap;word-break:break-word;margin-top:8px;font-size:13px;color:#d7dbe3;}
