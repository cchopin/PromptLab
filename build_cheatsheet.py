...
CSS = """
:root{--bg:#0c0d10;--bg-alt:#14161b;--panel:#1b1e25;--accent:#9aafce;--text:#f1f3f7;--muted:#b0b6c2;--ok:#a6c0a2;--warn:#cc9a76;--err:#cf8a82;--border:#2a2e37;--sans:-apple-system,system-ui,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;--mono:"SFMono-Regular","Consolas","Menlo","Monaco",monospace;}
...
.disclaimer{color:var(--warn);border:1px solid var(--border);border-radius:6px;padding:8px 12px;background:rgba(204,154,118,0.08);font-size:12px;margin:14px 0;}
...
input,select,textarea{background:var(--bg-alt);color:var(--text);border:1px solid var(--border);border-radius:4px;padding:8px 10px;font-family:var(--sans);font-size:13px;}
input#search{min-width:220px;flex:1;}input#target-input{min-width:240px;}
.count{color:var(--muted);font-size:12px;}
.count-line{margin:2px 0 4px;font-size:12px;}
.btn{background:var(--panel);color:var(--text);border:1px solid var(--border);border-radius:4px;padding:5px 11px;cursor:pointer;font-family:var(--sans);font-size:12px;}
...
.b-obj{background:#241f2e;}.b-type{background:#1c2530;}
.status-btn{cursor:pointer;border:1px solid var(--border);border-radius:4px;padding:2px 9px;font-size:11px;background:var(--bg);color:var(--muted);font-family:var(--sans);}
...
.pl-body{background:#090a0d;border:1px solid var(--border);border-radius:4px;padding:10px;white-space:pre-wrap;word-break:break-word;margin-top:8px;font-size:13px;color:#d7dbe3;font-family:var(--mono);}
